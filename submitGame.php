    ...
    if(!problems){
        ...
        $.post( "../framework/tools/ajaxRequests.php", {submitGame : "true", SGteam1 : team1, SGteam2 : team2, SGdivision : division, SGdate : date, SGwinner : winner, 'SGteam1Sel[]' : selTeam1, 'SGteam2Sel[]' : selTeam2, 'SGteam1ID[]' : selTeam1ID, 'SGselTeam2ID[]' : selTeam2ID})
    	 .done(function(data) {
			alert(data);
                if(data == "Game Exists")
                    $("#rightContainer").html("Game already exists, <a href='./submitGame.php'>Try Again</a>");
                else if(data == "Match not Found")
                    $("#rightContainer").html("There was a problem locating the match, <a href='./submitGame.php'>Try Again</a>");
                else
                    ...
                    <div class="4u">
                        <div class="sidebar">
                            ...
                            <ul class="style2">
                                ...
                                <li>Add Team</li>
                                <li>Add Players</li>
                                <li><a href="http://www.competeleague.com/AdminArea/submitGame.php">Submit Game</a></li>
                            </ul>
                            <footer><a href="http://competeleague.com/index.php" class="button button-icon button-icon-rarrow">Homepage</a></footer>
                        </div>
                    </div>
