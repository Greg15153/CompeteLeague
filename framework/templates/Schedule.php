...
<?php
	...
	if($league == 'Silver'){
		$contentLoc = "framework/templates/Content/Silver/Schedule.html";
		include_once($contentLoc);
	}
	else if($league == 'Platinum'){
		$contentLoc = "framework/templates/Content/Platinum/Schedule.html";
		include_once($contentLoc);
	}
	else if($league == 'Diamond'){
		$contentLoc = "framework/templates/Content/Diamond/Schedule.html";
		include_once($contentLoc);
	}
