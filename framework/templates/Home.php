								...
								<div class="row">
									<div class="6u">
										<section>
											...
											<footer>
												<a href="?do=" class="button button-medium button-alt button-icon button-icon-info">Read More</a>
											</footer>
										</section>
									</div>
                      <div class="6u">
										<section>
											...
											<footer>
												<a href="?do=Contact&reason=Jobs" class="button button-medium button-alt button-icon button-icon-info">Click here</a>
											</footer>
										</section>
                                      <section>
                                      <center> </center>
