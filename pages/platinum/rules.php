<?php @readfile("http://competeleague.bloccrew.com/templates/header.php"); ?>
<?php @readfile("http://competeleague.bloccrew.com/templates/left-nav-dia.php"); ?>
								<div class="8u skel-cell-mainContent">
									<div id="content">
										...
										<li>No foul language or disrespectful trash talk in the pre game lobby, or in all chat, friendly trash talking is permitted however</li>      <!-- Content -->
									</div>
								</div>
							</div>
						</div>
...
<?php @readfile("http://competeleague.bloccrew.com/templates/footer.php"); ?>