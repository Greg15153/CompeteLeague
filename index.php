							...
							<!-- Banner -->
								<div id="banner">
								  ...
								  <p>Take A look at whats new!</p>
									<a href="pages/GCL_Week1.html" class="button button-big button-icon button-icon-rarrow">Click Here</a>
						...
						<!-- Feature 1 -->
							<section class="container box-feature1">
								...
								<div class="row">
									<div class="4u">
										<section>
											<span class="image image-full"><a href="http://competeleague.bloccrew.com/pages/scl/"><img src="imgs/croppedlogo.jpg" alt="" /></a></span>
									...
									<div class="4u">
											<section>
											<span class="image image-full"><a href="http://competeleague.bloccrew.com/pages/platinum/"><img src="imgs/croppedlogo.jpg" alt="" /></a></span>
									...
									<div class="4u">
										<section>
											<span class="image image-full"><a href="http://competeleague.bloccrew.com/pages/diamond/"><img src="imgs/croppedlogo.jpg" alt="" /></a></span>
									...
									<div class="6u">
										<section>
											<header class="major">
												...
												<span class="byline">Check out some of our older productions</span>
											</header>
											<p>Check out some of the old games played in the CompeteLeague tournaments</p>
											<footer>
												<a href="pages/GCL_Qpowers.html" class="button button-medium button-alt button-icon button-icon-info">Read More</a>
											</footer>
										</section>
									</div>
                      <div class="6u">
										<section>
											<header class="major">
											  <h2>Job Sign ups</h2>
												<span class="byline">Help out CompeteLeague!</span>
											</header>
											<p>Want to help CompeteLeague grow and succeed? Come apply for a job at CompeteLeague here</p>
											<footer>
												<a href="pages/jobs.html" class="button button-medium button-alt button-icon button-icon-info">Click here</a>
											</footer>
										</section>
                                      <section>
                                      <center> </center>
